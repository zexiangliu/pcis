function [ pwd_A , pwd_C ] = get_takeover_pwd_nonoise( )
...
pwd_A = PwDyn(dom, { r1, r2, r3, r4, r5 } , ...
                { Dyn(A+A_r1, F_r1, B, XU , {} , {} , Polyhedron()), ...
                  Dyn(A+A_r2, F_r2, B, XU , {} , {} , Polyhedron()), ...
                  Dyn(A+A_r3, F_r3, B, XU , {} , {} , Polyhedron()), ...
                  Dyn(A+A_r4, F_r4, B, XU , {} , {} , Polyhedron()), ...
                  Dyn(A+A_r5, F_r5, B, XU , {} , {} , Polyhedron())} );
