...
Hx_r2 = [   con.K_cau*con.dt + [ 0 0 0 (1-con.f2*con.dt) ] ;
...
%Create State Dependent Disturbance
Ew_r2 = [zeros(3,1);con.dt];
XW_V_r2 = { [zeros(1,4),con.aL_min],[con.K_cau,con.dLmax] };
...
%Create State Dependent
Ew_r3 = Ew_r2;
XW_V_r3 = { [con.K_cau,con.dLmin],[zeros(1,4),con.aL_max] };
...
pwd_C = PwDyn(dom, { r1.intersect(dom), r1_5.intersect(dom), r2.intersect(dom), r3.intersect(dom), r4.intersect(dom), r5.intersect(dom) , r5_5.intersect(dom) } , ...
                { Dyn(A+A_r1, F_r1, B, XU , {} , {} , Polyhedron(), Ad, Bw_r1 , D , [] , {} , Ew_r1 , XW_V_r1), ...
                  Dyn(A+A_r1, F_r1, B, XU , {} , {} , Polyhedron(), Ad, Bw_r1 , D , [] , {} , Ew_r1 , XW_V_r1), ...
                  Dyn(A+A_r2, F_r2, B, XU , {} , {} , Polyhedron(), Ad, Bw_r2 , D , [] , {} , Ew_r2 , XW_V_r2), ...
                  Dyn(A+A_r3, F_r3, B, XU , {} , {} , Polyhedron(), Ad, Bw_r3 , D , [] , {} , Ew_r3 , XW_V_r3), ...
