...
%         subplot(211)
        ...
        plot([-200 4000],[6.4,6.4],'k--','LineWidth',3);
        plot([-200 4000],[9.8,9.8],'k-','LineWidth',3);
        axis([xEgoC1-100 xEgoC1+100 -10 10])
        plot(xEgoC1, yEgoC1 + 4.8, 'sb', 'markersize', 5,'MarkerFaceColor', 'b');
        plot(xEgoC1+hC1, 4.8, 'sr', 'markersize', 5,'MarkerFaceColor', 'r');
        text(xEgoC1+hC1, 4.3,'cautious','HorizontalAlignment', 'center');
        text(xEgoC1, 6 + xC1(2),'ego wo sp','HorizontalAlignment', 'center');

        % cautious scenario
        
        plot(xEgoC2, yEgoC2 - 8.1, 'db', 'markersize', 5,'MarkerFaceColor', 'b');
        plot(xEgoC2 + hC2, -8.1, 'dr', 'markersize', 5, 'MarkerFaceColor', 'r');
        text(xEgoC2 + hC2, -8.6 , 'cautious', 'HorizontalAlignment', 'center');
        text(xEgoC2, -6.9 + xC2(2),'ego wt sp','HorizontalAlignment', 'center');
